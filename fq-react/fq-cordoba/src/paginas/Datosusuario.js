  ...
  return (
    <Container id="main-container" className="d-grid h-100">
      <Form id="register-form" className="w-100 text-center bg-white">
        ...
        <h1 className="fs-3 fw-normal mb-3">Datos de Usuario</h1>
        <Row>
          ...
          <Col md={{ span: 6}}><Form.Group controlId="register-nombre" className="mb-1">
        ...
        <Row>
          <Col>
          <Form.Group controlId="register-email" className="mb-1">
          <Form.Control type="email" size="lg" placeholder="Email" autoComplete="off" className="position-relative" required/>
          </Form.Group>
          </Col>
          <Col><Form.Group controlId="register-apellido" className="mb-1">
